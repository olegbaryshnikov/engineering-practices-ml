...
class myClass():
    ...
    def MethodWithLongNameAndManyParameters(self, param1,
    ...
    def another_method(self):
        print("This method has a single-line \
              definition violating PEP8 conventions.")

    def yet_another_method(self):
        # This method violates PEP8's recommendation
        # for blank lines around function/method definitions
